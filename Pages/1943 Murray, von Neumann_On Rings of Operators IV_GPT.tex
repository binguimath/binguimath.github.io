...
\[
  \OpNorm{q_\nu(A_{\nu'})-\psi(A_{\nu'})}\leq\frac1\nu,\footnote{\phantomsection\label{fn:11}The set
...
and
\begin{equation}
  \OpNorm{q_\nu(A_{\nu'})}\leq\OpNorm{A}.{}^{\hyperref[fn:11]{11}}
...
\[
  \Metric{F_1-F}
  =\bigl(\lvert D_{\M}(F_1)-D_{\M}(F)\rvert\bigr)^{1/2}.\footnote{\phantomsection\label{fn:35}
...
\raisebox{0.45ex}{\textsuperscript{\hyperref[fn:35]{35}}}, and therefore
\[
...
\(\mathfrak G\) (cf. footnote~\hyperref[fn:48]{48}), and so both \(\M=\R(I)\) and
