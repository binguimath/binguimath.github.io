...
$\lambda\notin\widetilde N_p-\overline{\widetilde N}_p$, or
$\lambda\in\Delta-\widetilde N_p-\overline{\widetilde N}_p$, and every
...
$\lambda\in\Delta-\widetilde N_p-\overline{\widetilde N}_p$ with
$M(\lambda)\ne N(\lambda)$.
...
\dfrac{1}{d_{M(\lambda)}(\overline E(\lambda))},
   &\text{for }\lambda\in\overline M,\\[0.35\baselineskip]
1,&\text{for }\lambda\notin\overline M.
\end{cases}
\]
...
Let the $\overline A_1,\overline A_2,\ldots$ be operators in $\mathfrak H^*$
...
$\mu_{\sigma(\lambda)}(C_f-C_f\overline M)=0$. In other words:
...
$\lambda\in\overline M$ implies
$\gamma(\lambda)\notin\overline K_0$, that is $\gamma(\lambda)>0$.
