...
> Borel functional calculus was introduced for the first time. Moreover, it was shown that if $\mathcal A$ is an abelian VN algebra generated by a bounded self-adjoint $T$, then $\mathcal A$ consists precisely of $f(T)$ for bounded Borel functions $f$. That is, abelian VN algebras are characterized by Borel functional calculus.
