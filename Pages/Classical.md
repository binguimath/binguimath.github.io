...
> Borel functional calculus was introduced. Moreover, it was shown that if $\mathcal A$ is a VN algebra generated by a bounded self-adjoint $T$, then $\mathcal A$ consists precisely of $f(T)$ for bounded Borel functions $f$.
