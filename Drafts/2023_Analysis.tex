...
We give some examples, and leave it to the readers to check that they satisfy the definition of metric spaces. We assume that square roots of positive real numbers can be defined.
...
Unless otherwise stated, the metrics on $\Rbb^n$ and $\Cbb^n$ are assumed to be Euclidean metrics.
