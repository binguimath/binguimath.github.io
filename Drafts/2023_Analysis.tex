...
\begin{df}
We say that a subset $A$ of a metric space $X$ is \textbf{closed} \index{00@Closed subsets} if the following condition is true: For every sequence $(x_n)$ in $A$ converging to a point $x\in X$, we have $x\in A$.
\end{df}
