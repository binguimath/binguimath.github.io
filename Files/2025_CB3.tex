...
\begin{align*}
0\rightarrow\bigcup_{a_\star}\ST^*_{\ff,a_\star}(\Wbb_3)\xlongrightarrow{\wht\alpha}\bigcup_{a_\star}\ST^*_{\ff,a_\star}(\Wbb_2)\xlongrightarrow{\wht\beta} \bigcup_{a_\star}\ST^*_{\ff,a_\star}(\Wbb_1)
\end{align*}
By the left exactness of $\ST^*_{\ff,a_\star}(-)$, the restriction of $\wht\alpha$ to each $\ST^*_{\ff,a_\star}(\Wbb_3)$ is injective, the map $\wht\beta$ sends each $\ST^*_{\ff,a_\star}(\Wbb_2)$ onto $\ST^*_{\ff,a_\star}(\Wbb_1)$, and the map $\wht\alpha$ sends each $\ST^*_{\ff,a_\star}(\Wbb_3)$ onto $\Ker(\wht\beta)\big|_{\ST^*_{\ff,a_\star}(\Wbb_2)}$. Therefore, the above sequence must be exact. This proves that $\bbs_\ff(-)$ is left exact, and hence $\boxtimes_\ff(-)$ is right exact.
\end{proof}
