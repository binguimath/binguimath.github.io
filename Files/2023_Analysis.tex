...
\begin{eg}
Define $f_n:(0,1)\rightarrow\Rbb$ by $f_n(x)=x^n$. Then $(f_n)_{n\in\Zbb_+}$ is equicontinuous and pointwise convergent, but not uniformly convergent. Accordingly, $(0,1)$ is not compact. 
\end{eg}
