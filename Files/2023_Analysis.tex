...
This example indicates why condition (1) of Thm. \ref{lb277} or (1') of Prop. \ref{lb281} is more natural than equicontinuity: Condition (1') of Prop. \ref{lb281} can be viewed as a continuity condition which is not ``equi" over all $\alpha$ in the index set $I$, but is ``equi" for sufficiently large $\alpha$.
 \hfill\qedsymbol
\end{eg}
