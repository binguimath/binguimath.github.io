...
\begin{proof}
We have $\Nbb\subset \Zbb_+\subset\Zbb\subset \Qbb$. By Schr\"oder-Bernstein, it remains to prove $\Qbb\precsim\Nbb$. First, note that $\Zbb_{<0}\approx\Nbb$. So by Thm. \ref{lb15}, $\Zbb=\Zbb_{<0}\cup\Nbb$ is countably infinite, and hence $\Zbb\approx\Nbb$. By Thm. \ref{lb15} again, $\Zbb\times\Zbb\approx\Nbb\times\Nbb\approx\Nbb$. By Exp. \ref{lb17}, there is a surjection from a subset of $\Zbb\times\Zbb$ to $\Qbb$. So $\Qbb\precsim\Zbb\times\Zbb\approx\Nbb$.
\end{proof}
