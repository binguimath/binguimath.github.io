...
\begin{thm}\label{lb4}
For each $x\in\Pbb^1\setminus\Sbf$ and $\uplambda\in\Lambda_x$, there is a unique bijection \index{zz@$\Psi_\uplambda$, the trivialization of $\varphi:C\rightarrow\Pbb^1$  determined by $\Psi_{\upgamma_\blt(1)}$}
\begin{gather*}
