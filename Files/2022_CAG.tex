...
\begin{itemize}
\item Claim: If $g\in\scr O_{m+1}$ is nonzero, then $\scr O_{m+1}/g\scr O_{m+1}$ is a Noetherian ring. 
\end{itemize}


Suppose the claim is true. Choose any non-zero ideal $I\subset\scr O_{m+1}$. Choose $0\neq g\in I$. By the claim, $I/g\scr O_{m+1}$, as an ideal of $\scr O_{m+1}/g\scr O_{m+1}$, is $\scr O_{m+1}/g\scr O_{m+1}$-finitely generated and hence $\scr O_{m+1}$-finitely generated. Thus, the exact sequence
\begin{align*}
