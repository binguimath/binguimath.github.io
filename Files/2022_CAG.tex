...
\begin{gather*}
\varinjlim_{i\in I}\mc H_n(\mc E_i\otimes_{\mc A}\mc F)\simeq\mc H_n\Big(\Big(\varinjlim_{i\in I}\mc E_i\otimes_{\mc A}\mc F\Big)\Big)\simeq\mc H_n\Big(\Big(\varinjlim_{i\in I}\mc E_i\Big)\otimes_{\mc A}\mc F\Big)
\end{gather*}
...
Let $\varphi:X\rightarrow Y$ be a holomorphic map where $Y$ is a complex manifold. Assume that one of the following equivalent conditions hold:
\begin{enumerate}[label=(\arabic*)]
