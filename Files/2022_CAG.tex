...
\item[(b)] Each $x\in X$ is contained in a neighborhood $U_x$ such that there exist finitely many $s_1,s_2,\dots\in\scr F(U_x)$ generating $\mc E_y$ for each $y\in U_x$.
\end{enumerate}
\end{pp}
