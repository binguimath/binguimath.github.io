...
Suppose the claim is true. Choose any non-zero ideal $I\subset\scr O_{m+1}$. Choose $0\neq g\in I$. By the claim, $I/g\scr O_{m+1}$, as a $\scr O_m$-submodule of $\scr O_m/g\scr O_m$, is $\scr O_{m+1}$-finitely generated. Thus, the exact sequence
\begin{align*}
...
\end{align*}
If $\varphi=0$, then $\scr E=\scr O_X^N$ is clearly of finite-type. So we assume $\varphi\neq 0$, i.e., one of $h_1,\dots,h_N$, say $h_1$, is nonzero. %Note that the non-zeroness of $h_1$ is preserved by shrinking $X$ to any connected open subset, thanks to Identit\"atssatz \ref{lb68}.
...
\begin{align*}
0\rightarrow\scr N\xrightarrow{\wtd\pi}\scr E\rightarrow\scr F\rightarrow0
\end{align*}
By assumption, $\scr O_Y$ is $\scr O_Y$-coherent. So $\scr F$ is $\scr O_Y$-finite-type (by Cor. \ref{lb45} and Cor. \ref{lb46}), and hence $\scr O_X$-finite-type. To prove that $\scr E$ is of finite-type, by Rem. \ref{lb193}, it remains to prove that $\scr N$ is a finite type $\scr O_X$-module. Let us prove that
\begin{align*}
...
\end{align*}
Since $s_1h_1+s_2h_2+\cdots+s_Ns_N=0$ because $(s_\blt)$ is killed by $\varphi$, we have
\begin{align*}
