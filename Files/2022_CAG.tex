...
(In the general case that $S$ is a reduced complex space, we say that $e\scr O(X)$ is a primitive element over $\scr O(S)$ if the zero locus of $D(\gamma_e)$ is nowhere dense in $S$.)  \hfill\qedsymbol
\end{df}
