...
\begin{proof}
``$\Rightarrow$" is obvious. Conversely, choose any $I\in\mc J$. Let $K$ be the dilation generator. Then there exists $s,t\in\Rbb$ such that $\exp^{\im sl_0}\exp^{\im tK}_tI=\Sbb^1_+$. Therefore, the M\"obius covariance transforms $[\fk A(\Sbb^1_+),\fk A(\Sbb^1_-)]=0$ to $[\mc A(I),\mc A(I')]=0$. This proves ``$\Leftarrow$".
\end{proof}
