...
\end{align*}
viewed as an unbounded operator on $\HV$. In general, if $T$ is a closable operator on $\HV$ with invariant domain $\HV^\infty$, and if $T^*\HV^\infty\subset \HV^\infty$, we let \index{T@$T^\dagger$, the formal adjoint} 
\begin{align*}
