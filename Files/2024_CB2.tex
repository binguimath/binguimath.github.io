...
Recall that \eqref{eqb52} is always assumed in this article, i.e, each connected component of each fiber $\wtd\fx_b$ of $\wtd\fx$ intersects at least one of the incoming marked points $\sgm_\blt(\wtd\MB)$. However, Thm. \ref{lbb49} often holds under a weaker condition: %Assume that each connected component of each fiber $\wtd\fx_b$ intersects at lesat one of the marked points $\sgm_\blt(\wtd\MB),\sgm'_\star(\wtd\MB),\sgm''_\star(\wtd\MB)$. 
