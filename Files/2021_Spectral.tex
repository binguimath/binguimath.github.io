...
\item Show that any unital $*$-closed subalgebra $A$ of $\End(\mc H)$ is generated by a set $\fk G$ of self-adjoint commuting operators. Conclude that any $A$ is equivalent (as a normed unital $*$-algebra) to $C(X)$ for some compact Hausdorff space $X$.
\end{enumerate}
\end{exe}
