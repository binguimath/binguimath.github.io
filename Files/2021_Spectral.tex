...
Let $\mc M\curvearrowright\mc H$ and $\mc N\curvearrowright\mc H$ be von Neumann algebras. Let \textbf{isomorphism} $\pi:\mc M\rightarrow\mc N$ be a unital $*$-homomorphism. Then the following conditions are equivalent.
\begin{enumerate}[label=(\arabic*)]
...
\begin{enumerate}
\item[(1)]  $\pi$ is normal.
\item[(2)] The restriction $\pi:B_{\mc M}\rightarrow\End(\mc H)$ is $\mc T$-continuous.
\end{enumerate}
\end{co}
