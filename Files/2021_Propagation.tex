...
\end{gather*}
whenever the local coordinates $\eta_0,\eta_\infty$ at $0,\infty$ is such that $(\Pbb^1;0,\infty;\eta_0,\eta_\infty)\simeq(\Pbb^1;0,\infty;\zeta,\zeta^{-1})$. It is easy to see that this definition is independent of the choice of such $\eta_0,\eta_\infty$. 
...
\bibitem[GPR]{GPR}
Hrauert, H., Peternell, T.,  Remmert, R. eds., 1994. Several complex variables VII: sheaf-theoretical methods in complex analysis (Vol. 74, p. 369). Springer.
