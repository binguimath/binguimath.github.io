...
\begin{df}
If $\fk S$ is a subset of $V$, we define the \textbf{orthogonal complement} \index{00@Orthogonal complement} of $\fk S$ (in $V$) to be
\begin{align*}
\fk S^\perp=\{\xi\in V:\bk{\xi|u}=0\text{ for all }u\in \fk S\}
\end{align*}
\end{df}
