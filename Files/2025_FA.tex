...
\subsubsection{Joint analytic vectors}

\begin{df}
Let $T_1,\dots,T_N$ be strongly commuting self-adjoint on $\MH$. Let \index{C@$C^\infty(T_\blt)$}
\begin{align*}
...
\begin{prob}
Let $T_1,\dots,T_N$ be strongly commuting self-adjoint operators on $\MH$. Let $f\in\Rbb[x_1,\dots,x_N]$. Suppose that $\fk A(T_\blt)$ is dense in $\MH$. Prove that $\FA(T_\blt)$ is a core for $f(T_\blt)$.
\end{prob}
