...
In von Neumann's spectral theory, by contrast, this non-uniqueness appears as the non-uniqueness of the self-adjoint extensions $\wht T$ of $T$. One may therefore interpret the various resolvents $(z-\wht T)^{-1}$ and the spectral decompositions of $\wht T$ as corresponding to the different possible resolvents and spectral decompositions of $T$ obtained using Hilbert's finite-approximation method. 
