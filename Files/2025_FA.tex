...
\begin{df}
Let $\omega:\MH\times\MH\rightarrow\Cbb$ be a bounded Hermitian form. Define $n_\pm$ to be the largest dimension (if exists) of closed linear subspaces $\MK\subset\MH$ such that $\pm\omega|_\MK$ is positive-definite (i.e. an inner product). We call $n_+$ and $n_-$ the \textbf{positive index of inertia} and \textbf{negative index of inertia} \index{00@Index of inertia} of $\omega$, respectively.
\end{df}
...
\begin{prob}
Let $\omega$ be a bounded Hermitian form on $\MH$. 
\begin{enumerate}
...
\end{align*}
\item Prove that the indices of inertia $n_+,n_-$ of $\omega$ exist. Moreover, for any decomposition as in Part 1, prove that $n_+=\dim\MH_+$ and $n_-=\dim\MH_-$.
\end{enumerate}
\end{prob}
