...
The notion of boundedness was first defined in this matrix context. Hilbert introduced this concept in \cite{Hil06}, where he also introduced the space $l^2(\Zbb)$. As established in Prop. \ref{lb35}, boundedness in the context of linear maps or sesquilinear forms is equivalent to (Lipschitz) continuity. However, as we will see below, in the setting of infinite matrices, boundedness takes on a stronger meaning---it implies equicontinuity. That is, boundedness in this context ensures that a family of linear maps or sesquilinear forms shares a uniform Lipschitz constant.

This distinction highlights a deeper philosophical insight under the perspective of infinite matrices: \uwave{a bounded linear operator or sesquilinear form is regarded as the limit of a sequence (or net) of finite-rank operators or forms}. This philosophy is deeply embedded in the study of spectral theory, which will be explored in Ch. \ref{lb114}, and aligns closely with the historical approaches of Hilbert and F. Riesz. For this reason, it is worthwhile to study bounded matrices and their relationship to bounded linear operators and sesquilinear forms.
