...
\end{align*}
with $p\in\Cbb[x]$. Recall that is the condition in the special case $I=[0,1]$. In the general $I=[a,b]$, the corresponding solvability condition is that $\Lambda(f)\geq0$ for all $f$ of one of the following three forms (with $p\in\Cbb[x]$):
...
\subsubsection{Proof of the Riesz spectral Thm. \ref{lb267}}
