...
\begin{proof}
This follows immediately from Thm. \ref{lb210} and Rem. \ref{lb212}.
\end{proof}

With the help of Thm. \ref{lb223}, one can easily generalize the MCT, the DCT, and Fatou's lemma from sequences to first-countable nets of functions. We leave the details to the reader.
...
\subsubsection{Compactness and cluster points}
...
\begin{align}
\liminf_{\alpha\in I}x_\alpha=\inf S\qquad \limsup_{\alpha\in I}x_\beta=\sup S
\end{align}
