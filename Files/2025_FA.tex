...
Following von Neumann's line of thought, we introduce in Sec. \ref{lb382} the first such notion: the notion of a closed Hermitian operator with zero deficiency indices. This is not yet the final definition of unbounded self-adjoint operators; indeed, in modern textbooks it often appears as a criterion for self-adjointness rather than a definition. Nevertheless, we will see that checking that a closed Hermitian operator has zero deficiency indices is frequently more convenient than checking self-adjointness directly, and that many central ideas in the theory of unbounded operators---such as the Cayley transform and the concept of closed operators---are more naturally understood from the perspective of deficiency indices.
...
\subsection{Cayley transform and extensions of Hermitian operators}\label{lb382}
...
\tcboxmath{-\im\frac{U+\idt}{U-\idt}:\Rng(U-\idt)\rightarrow\MH\qquad (U-\idt)\eta\mapsto -\im(U+\idt)\eta}
\end{align}
where $\eta\in\Dom(U)$.
