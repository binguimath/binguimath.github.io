...
The idea outlined in Rem. \ref{lb110} is roughly the approach Riesz employed in \cite{Rie07a} to solve the following trigonometric moment problem.
...
\begin{proof}[\textbf{Riesz's proof}]\footnote{See \cite[Ch. 6]{Haw-L} or \cite{Rie07a}.}
