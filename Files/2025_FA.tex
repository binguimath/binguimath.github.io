...
Recall from Thm. \ref{lb192} that any pair of real sequences $(a_n)_{n\in\Nbb}$ and $(b_n)_{n\in\Nbb}$ with $a_n>0$ arises from a unique sequence $(c_n)_{n\in\Nbb}$ with positive Hankel matrix and $c_0=1$ in the manner described in Thm. \ref{lb454}.
...
The goal of this section is show that any positive operator admits a canonical extension that is both positive and self-adjoint, called the Friedrichs extension.
