...
\subsubsection{Strong commutativity of self-adjoint operators}
...
\right.
\end{gather*}
\item Conclude that if $I=(0,+\infty)$, the Hermitian operator $T$ has deficiency indices $(1,0)$, and hence has no self-adjoint extensions.
