...
Prop. \ref{lb252}, which gives us a linear functional interpretation of measure theory, allows us to formulate the Riesz-Markov representation theorem (Thm. \ref{lb7}) for compact metrizable spaces in the form of monotone convergence extension.


\begin{thm}[\textbf{Riesz-Markov representation theorem}]\label{lb253} \index{00@Riesz-Markov representation theorem}
Let $X$ be a compact metrizable space. Then any positive linear functional $\Lambda:C(X,\Kbb)\rightarrow\Kbb$ can be extended uniquely to a normal positive linear functional $\Lambda:\Borb(X,\Kbb)\rightarrow\Kbb$.
\end{thm} 
