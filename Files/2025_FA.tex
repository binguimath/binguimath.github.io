...
Another reason that the theory of compact operators looks obscure is that, especially in partial differential equations, the modern usage of compact operators differs quite a lot from the historical usage.

Let us explain the difference for the \textbf{Dirichlet problem}. Let $\Omega$ be a bounded open subset of $\Rbb^N$, and assume that $\Omega$ has smooth boundary. Given
