...
What von Neumann meant by ``partial results'' can be inferred from the first half of Footnote 23 in \cite{vN29a}, where he comments on his earlier attempt to study the spectral theorem for Hermitian operators using Hilbert’s method of finite approximation:
