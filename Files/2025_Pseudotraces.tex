...
Our construction of the associative algebra structure on $\boxtimes_\fn\Cbb$ differs fundamentally from all previous approaches to associative algebras in the VOA context: it is purely geometric, in the sense of Segal's CFT and coboordism categories. 
...
\vcenter{\hbox{{\includegraphics[height=2cm]{fig1.pdf}}}}
\qquad\text{and}\qquad
\vcenter{\hbox{{\includegraphics[height=2cm]{fig8.pdf}}}}
\end{align}
