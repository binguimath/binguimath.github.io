...
In the remaining part of this article, \uwave{we always assume that $\mc A$ is an irreducible M\"obius net}. 




There are two equivalent ways to make $\Rep(\mc A)$ a braided $C^*$-tensor category: the Doplicher-Haag-Roberts (DHR) superselection theory \cite{DHR71,DHR74,FRS89,FRS92}, and the Connes fusion \cite{Con80,Sau83,Was98,BDH17}. In this article, we focus on the latter. 
