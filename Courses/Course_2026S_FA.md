...
23) 5/19 酉算子与自伴算子交换=酉算子与Cayley变换交换=酉算子与单参数酉群交换（Prop. 6.10.7, 7.3.12），Stone定理证明完成，$R^N$的强连续酉表示转化为卷积代数$C_c(R^N)$的酉表示，Fourier变换的L1理论，$R^N$卷积代数酉表示=Fourier变换的Borel函数演算
