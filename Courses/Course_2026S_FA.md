...
- 作业时间：一学期预计有6次作业，每次作业预计给大家两周的时间完成。平时作业对于巩固课程知识而言非常重要。请大家务必**按时完成作业**！
...
- 2/26 
- 1/2 矩问题的有限逼近解法转化为证明有限维情形时J等距，J等距的几何意义（凸集分离），一般赋范空间里的凸集分离，凸集的范数闭包等于弱闭包

  讲义章节：9.2.2-9.2.4，9.3，9.4
